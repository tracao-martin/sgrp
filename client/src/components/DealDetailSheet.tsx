  ...
  return (
    <>
      <Sheet open={open} onOpenChange={onOpenChange}>
        <SheetContent className="w-full sm:max-w-[600px] bg-gray-900 border-gray-700 overflow-y-auto" side="right">
          {isLoading ? (
            ...
            <div className="space-y-5 pb-6">
              <SheetHeader>
                <SheetTitle className="text-xl text-white flex items-center gap-2">
                  ...
                  {deal.status === "aberta" && <Badge className="bg-blue-600 text-white">Aberta</Badge>}
                </SheetTitle>
              </SheetHeader>
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab}>
                <TabsList className="w-full bg-gray-800 border border-gray-700">
                  <TabsTrigger value="spin" className="flex-1 data-[state=active]:bg-blue-600 text-xs">
                    <Sparkles className="w-3 h-3 mr-1" /> SPIN
                  </TabsTrigger>
                  <TabsTrigger value="qualification" className="flex-1 data-[state=active]:bg-blue-600 text-xs">
                    <CheckCircle2 className="w-3 h-3 mr-1" /> Qualificação
                  </TabsTrigger>
                  <TabsTrigger value="probability" className="flex-1 data-[state=active]:bg-blue-600 text-xs">
                ...
                <TabsContent value="spin" className="space-y-4 mt-4">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mb-1">Contexto atual do cliente. Como opera hoje?</p>
                      <Textarea
                        value={spinSituacao}
                        ...
                        className="bg-gray-800 border-gray-700 text-sm min-h-[80px]"
                        disabled={isClosed}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mb-1">Quais dores e dificuldades o cliente enfrenta?</p>
                      <Textarea
                        value={spinProblema}
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mb-1">Qual o impacto financeiro/operacional do problema?</p>
                      <Textarea
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mb-1">O que o cliente precisa resolver? Qual o cenário ideal?</p>
                      <Textarea
                ...
                <TabsContent value="qualification" className="space-y-4 mt-4">
                        ...
                        >
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              <Icon className={`w-4 h-4 ${checked ? "text-green-400" : "text-gray-400"}`} />
                  ...
                  <div className="bg-gray-800 rounded-lg p-3">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm text-gray-300">Score de Qualificação</span>
                  ...
                  <div className="space-y-3">
                    <div className="bg-gray-800 rounded-lg p-4">
                      <div className="flex items-center justify-between mb-3">
                        <span className="text-sm text-gray-300">Probabilidade Automática (Estágio)</span>
                    ...
                    <div className={`rounded-lg p-4 border transition-colors ${
                      useManualProb ? "bg-amber-900/20 border-amber-700" : "bg-gray-800 border-gray-700"
                    }`}>
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2">
                          <Checkbox
                            ...
                            disabled={isClosed}
                          />
                          <span className="text-sm text-gray-300">Sobrescrever com valor manual</span>
                        </div>
                        {useManualProb && (
      ...
      <Dialog open={showWinDialog} onOpenChange={setShowWinDialog}>
        <DialogContent className="bg-gray-800 border-gray-700">
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setShowWinDialog(false)} className="border-gray-600">
              Cancelar
            </Button>
            <Button
      ...
      <Dialog open={showLossDialog} onOpenChange={setShowLossDialog}>
        <DialogContent className="bg-gray-800 border-gray-700">
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setShowLossDialog(false)} className="border-gray-600">
              Cancelar
            </Button>
            <Button
