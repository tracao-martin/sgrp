...
const CATEGORIA_CORES: Record<string, string> = {
  ...
  Software: "bg-blue-900/30 text-blue-300",
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <Card className="bg-gray-800/50 border-gray-700">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-xs text-gray-400">MRR potencial</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex gap-1">
          {(["todos", "ativos", "inativos"] as const).map((s) => (
            <Button
              ...
              className={filterStatus === s ? "bg-blue-600" : "border-gray-600 text-gray-300"}
            >
        ...
        <div className="flex gap-1 flex-wrap">
          <Button
            ...
            className={filterCategoria === null ? "bg-blue-600" : "border-gray-600 text-gray-300"}
          >
            Todas
          </Button>
          {categorias.map((cat) => (
            <Button
              ...
              className={filterCategoria === cat ? "bg-blue-600" : "border-gray-600 text-gray-300"}
            >
              {cat}
            </Button>
          ))}
        ...
        {filteredProdutos.map((produto) => (
          <Card
            ...
            className={`border-gray-700 transition-all ${
              produto.ativo ? "bg-gray-800" : "bg-gray-800/50 opacity-70"
            }`}
          >
            <CardContent className="p-4 space-y-3">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <Badge className={`mt-1 text-xs ${CATEGORIA_CORES[produto.categoria] || "bg-gray-700 text-gray-300"}`}>
                    {produto.categoria}
                  </Badge>
                </div>
                <Switch
              ...
              <p className="text-xs text-gray-400 line-clamp-2">{produto.descricao}</p>
        ...
        <DialogContent className="bg-gray-800 border-gray-700 max-w-lg">
          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="text-sm font-medium text-gray-300">Recorrência</label>
                <select
